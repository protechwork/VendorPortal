...
{
    public class oGeneralized_RelPO_POSController : Controller
    {
                                    ...
                                    for (int i = 0; i <= tempFor1; i++)
                                    {
                                        ...
                                        using (var client = new WebClient())
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                strErrorMessage = "";
                                                strErrorMessage = "";
                                                strQry = $@"update tMrp_ProdOrder_0  set iTagFilterId=3,sSONO='" + sPostDoc + "/" + t.ToString() + "', iTagFilterValue=" + iDeptId + ",iOrderStatus=2 where sProdOrderNo='" + sPostDoc + "'";
